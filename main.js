let res
  function shorturl() {
    ...
    fetch(window.location.pathname, {
      ...
      body: JSON.stringify({ url: document.querySelector("#text").value , title: document.querySelector("#title").value })
  ...
  .then(function(myJson) {
    ...
    if(res.key!=="")
    document.getElementById("result").innerHTML="social.exposition.lk"+res.key;
